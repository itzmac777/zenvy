...
export function SimpleManagerVerify() {
  ...
  const verifyCode = useCallback(async (nextCode: string) => {
    if (!challenge || nextCode.length !== 6 || verifyingRef.current || submittedRef.current === nextCode) return;
